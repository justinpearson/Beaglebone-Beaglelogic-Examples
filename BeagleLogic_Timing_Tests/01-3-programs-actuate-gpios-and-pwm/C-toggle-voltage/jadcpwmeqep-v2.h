#ifndef JADCPWMEQEP_V2_HPP
#define JADCPWMEQEP_V2_HPP

int j_read_adc( unsigned int channel );
int j_pwm_start( float duty, float freq );
int j_pwm_stop();
int j_pwm_set_duty( float duty );
int j_gpio_();
